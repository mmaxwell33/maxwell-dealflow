...
const Pipeline = {
  ...
  async createFromOfferWithDates(offer, client, dates) {
    ...
    // pipeline.id is auto-generated by Postgres; commission_rate lives on the
    // separate `commissions` table (inserted later in this function).  Including
    // those two columns here causes PGRST204 ("column not found in schema cache").
    const _pInsert = {
      agent_id: currentAgent.id,
  ...
  async createFromOffer(offer, client) {
    ...
    // pipeline.id is auto-generated by Postgres; do not include `pipeline_id`.
    const _pInsert = {
      agent_id: currentAgent.id,
      client_id: offer.client_id,
      client_name: client?.full_name || offer.client_name,
