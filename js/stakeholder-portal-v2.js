...
(function(){
  ...
  function render(d){
    ...
    // ============ DEAL DOCUMENTS — intentionally NOT shown in the portal ============
    // Documents are no longer surfaced here. They were served from a public
    // storage link that never expired, so anyone with the URL could open them
    // forever. Documents are now delivered as email attachments to the client /
    // stakeholder instead, so nothing sensitive sits on an open web link.
