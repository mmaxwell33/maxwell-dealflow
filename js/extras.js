...
const EmailSend = {
  ...
  // ── Email templates ──────────────────────────────────────────────────
  // PR #42: signature lines REMOVED from every template body. The full
  // signature (name + role + 📞 / ✉️ / 🌐 / disclaimer) is appended
  // automatically by EmailFormat.htmlEmail at send time. Templates
  // should end with the natural closing sentence ("Looking forward to
  // hearing from you!" etc.) — nothing more.
  templates: {
