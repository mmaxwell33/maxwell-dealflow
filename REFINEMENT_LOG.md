...
## PR #15 — `chore/remove-client-side-lockout`
...
## PR #17 — `chore/onSignedIn-setTimeout-cleanup`
...
## PR #19 — `ui/cmd-k-client-search`

**Closes:** Follow-up to PR #18 — adds the searchable-database half of the command palette.
